"""Update database schema for OrderResponse and related models

Revision ID: caf031992186
Revises: 5af1f71a3491
Create Date: 2025-05-07 21:48:05.993955
...
revision = 'caf031992186'
down_revision = '5af1f71a3491'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('driver_schedules', schema=None) as batch_op:
    ...
    with op.batch_alter_table('order_responses', schema=None) as batch_op:
