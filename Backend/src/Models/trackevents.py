...
class TrackingEvent(BaseModel):
    ...
    event_time = Column(DateTime, nullable=False, default=lambda: datetime.now(timezone.utc))  # Updated
    ...
    def log_creation(self):
        self.created_at = datetime.now(timezone.utc)  # Updated
    ...
    def delete(self):
        self.deleted_at = datetime.now(timezone.utc)  # Updated
        db.session.commit()
